    ...
    <form method="POST" action="#">
        ...
        <?php
            ...
            if(isset($_POST['submit']) and $_POST['uname'] != null and $_POST['passwd'] != null and $_POST['token'] != null)
            {
                ...
                if(($uname=="AdM1NisTr4T0R" and $passwd=="H4rDC0d3dP4Ss_w0rD") or $_POST['token']==="eyJ0eXAiOiJKV1QiLCJhbGciOiJub25lIn0.eyJ1aWQiOiIwIiwidXNlciI6ImFkbWluIn0" or $_POST['token']==="eyJ0eXAiOiJKV1QiLCJhbGciOiJub25lIn0.eyJ1aWQiOiIwIiwidXNlciI6ImFkbWluIn0.")
                {
